# Available .SOY One-Word Domains (5,622,022)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C868%20rows-8250df">
...
> **Important:** this repository is a **public 9,868-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,022 domains** on the canonical page below.

**Public extract:** 9,868 rows · **Live catalog:** 5,622,022 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/soy?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_soy_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/soy?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_soy_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./soy.csv">CSV</a> / <a href="./soy.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_soy_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_soy_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .SOY search](https://unique.domains/domains/tld/soy?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_soy_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .SOY search](https://unique.domains/domains/tld/soy?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_soy_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./soy.csv) or [Download JSON](./soy.json)
...
- `soy.csv` — public CSV extract (9,868 rows)
- `soy.json` — public JSON extract (9,868 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,868-row public sample | 5,622,022 live domains                           |
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ---------- |
| nationwide.soy | available | $24.99    | $24.99        | 76             | 66     | 10     | name.com   |
| biological.soy | resell    | —         | —             | 92             | 9      | 10     | eNom, Inc. |
| converse.soy   | premium   | $48.75    | $48.75        | 64             | 73     | 8      | name.com   |
...
| data.soy       | premium   | $698.10   | $698.10       | 70             | 60     | 4      | namecheap  |
...
| live.soy       | premium   | $623.75   | $623.75       | 108            | 55     | 4      | name.com   |
...
| business.soy   | premium   | $698.10   | $698.10       | 100            | 54     | 8      | namecheap  |
...
> Unique Domains. *Available .SOY One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
